    ...
    <div class="container" style="margin-top: 200px;">
        <div class="row">
            <div class="col-6 offset-3">
                <form method="POST" action="{{ route('turnos.destroy', ['id' => $turno->id]) }}">
                    @csrf
                    @method('DELETE')

                    <div class="form-group">
                        <label for="name">Confirme el borrado de <strong>{{$turno->hora}}</strong> pulsando el botón a continuación</label>
                    </div>
